...
The [issue tracker](https://github.com/binance/binance-connector-ruby/issues) is
...
> 3.  Further steps, etc.
>
> (Add link to a demo on https://replit.com/languages/ruby or similar if possible)
>
> **Expected behavior**
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/binance-connector-ruby.git
    # Navigate to the newly cloned directory
    cd binance-connector-ruby
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/binance/binance-connector-ruby.git
    ```
...
6. Execute the document generation script and check the output `.html` file in `/doc` folder to make sure your code change is clearly described.

    ```bash
    rbenv exec bundle exec yardoc lib
    ```
