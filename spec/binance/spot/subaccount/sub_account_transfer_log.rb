...
RSpec.describe Binance::Spot::Convert, '#sub_account_transfer_log' do
  let(:path) { '/sapi/v1/managed-subaccount/queryTransLogForTradeParent' }
  ...
  context 'validation' do
    ...
    with_them do
      it 'should raise validation error without mandatory params' do
        expect { spot_client_signed.sub_account_transfer_log(**params) }.to raise_error(Binance::RequiredParameterError)
      end
    end
  end
  ...
  context 'with params' do
    ...
    it 'should return managed sub account transfer log' do
      spot_client_signed.sub_account_transfer_log(**params)
